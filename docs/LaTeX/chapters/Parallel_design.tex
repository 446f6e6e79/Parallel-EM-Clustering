...
These local results are then aggregated into global via reduction operations to form the sufficient statistics.
Then every processing unit finalizes the parameter updates (Algorithm \ref{parallel_m_step}).
...
limited, as only the GMM parameters need to be communicated. 
