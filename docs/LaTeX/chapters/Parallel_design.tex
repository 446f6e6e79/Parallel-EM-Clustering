...
\hline
\texttt{log\_likelihood} & 22 & $i$ & read & 22 & $i$ & write & no & anti \\ 
\hline
\texttt{log\_likelihood} & 22 & $i$ & write & 22 & $i + 1$ & write & yes & output \\ 
\hline
\texttt{log\_likelihood} & 22 & $i$ & write & 22 & $i + 1$ & read & yes & flow \\ 
\hline
\texttt{denom} & 15 & $i,k$   & read  & 15 & $i,k$ & write & no & anti \\
\hline
\texttt{denom} & 15 & $i,k$   & write  & 15 & $i,k+1$ & read & yes & flow \\
\hline
\texttt{gamma}$(i * k + k)$   & 13 & $i,k$   & write  & 15 & $i,k$ & read & no & flow \\
\hline
\texttt{gamma}$(i * k + k)$   & 15 & $i,k$   & read  & 20 & $i,k$ & write & no & flow \\
\hline
\end{tabular}}
\end{table}
