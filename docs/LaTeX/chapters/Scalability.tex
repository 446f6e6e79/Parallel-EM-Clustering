...
%#TODO: report here the n_process and n_threads used for the hybrid approach, saying that
%for semplicity and clarity with previous tables, in the tables we report only the n_processes * n_thread used.
