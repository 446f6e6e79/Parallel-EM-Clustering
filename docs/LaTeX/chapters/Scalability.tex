...
In this analysis we keep number of features and number of clusters constant, as not involved in the parallelization.
\begin{table}[h!]
    \centering
...
\end{table}
%# TODO: Analysis of the weak scalability and strong scalability
%# TODO: Analysis of the efficiency of E-step and M-step separately. Comment on the fact that the result is as expected according to the theoretical analysis and propose hybrid parallelization to improve M-step efficiency.
\begin{table}[h!]
    \centering
    \renewcommand{\arraystretch}{1.2}
    \setlength{\tabcolsep}{4pt}
