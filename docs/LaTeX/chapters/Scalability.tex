...
To maintain consistency and facilitate comparison with previous results, we used the total number of processes as a reference.
\begin{table}[h!]
    \centering
    \begin{tabular}{c c c}
    \hline
    \textbf{Nodes} & \textbf{NCPUs} & \textbf{Threads} \\
    \hline
    1 & 1 & 1 \\
    1 & 1 & 2 \\
    1 & 1 & 4 \\
