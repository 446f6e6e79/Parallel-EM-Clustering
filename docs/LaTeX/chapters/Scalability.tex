...
For our benchmarking experiments, we used a \texttt{pack:excl} setting on the cluster to have exclusive access to the allocated nodes and try to allocate all processes on the same node.
