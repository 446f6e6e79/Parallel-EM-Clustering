...
#else
// If DEBUG is not defined, provide NOP inline implementations
static inline void debug_print_first_samples(Metadata *metadata, double *X, int *ground_truth_labels) {
    (void)metadata; (void)X; (void)ground_truth_labels;
}

static inline void debug_print_cluster_params(Metadata *metadata, ClusterParams *cluster_params) {
    (void)metadata; (void)cluster_params;
}

static inline void debug_print_scatter(int local_N, int D, double *local_X, int rank) {
    (void)local_N; (void)D; (void)local_X; (void)rank;
}

static inline void debug_println(const char *fmt, ...) {
    (void)fmt;
}
#endif
